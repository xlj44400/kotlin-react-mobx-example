...
type ComponentClass<P> = ComponentClass<P>;
type StatelessComponent<P> = StatelessComponent<P>;
type Component<P> = ComponentClass<P>;
type ReactNode = ReactNode;
type Store<S> = Store<S>;
type Dispatch<S> = Dispatch<S>;
type ActionCreator<A> = ActionCreator<A>;
